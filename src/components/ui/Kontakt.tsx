                    ...
                    <form>
                        <div className="grid gap-4 lg:gap-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                ...
                                <div>
                                    <label htmlFor="hs-phone-number-1" className="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Phone Number</label>
                            ...
                            <div>
                                <label htmlFor="hs-about-contacts-1" className="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Details</label>
